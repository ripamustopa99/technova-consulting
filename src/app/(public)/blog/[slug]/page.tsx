    ...
    <div className={`${inter.className} bg-slate-950 text-slate-50 min-h-screen pb-24`}>
      ...
      <section className="px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <article
            className="prose-custom break-words overflow-hidden [&_p]:mb-6 [&_p]:leading-relaxed [&_p]:text-slate-300 [&_p]:text-base md:[&_p]:text-[17px] [&_h2]:text-2xl lg:[&_h2]:text-3xl [&_h2]:font-bold [&_h2]:text-white [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:break-words [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-white [&_h3]:mt-8 [&_h3]:mb-3 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:mb-6 [&_li]:mb-2 [&_li]:text-slate-300 [&_a]:text-cyan-400 [&_a]:underline hover:[&_a]:text-cyan-300 [&_a]:break-all [&_strong]:text-white [&_em]:text-slate-200 [&_blockquote]:border-l-4 [&_blockquote]:border-cyan-500 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-slate-400 [&_blockquote]:my-6 [&_pre]:bg-slate-900 [&_pre]:p-4 [&_pre]:rounded-xl [&_pre]:overflow-x-auto [&_pre]:text-sm [&_pre]:my-6 [&_img]:max-w-full [&_img]:h-auto [&_table]:w-full [&_table]:overflow-x-auto [&_td]:break-words"
